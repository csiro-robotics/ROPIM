...
def parse_option():
    ...
    parser.add_argument('--output', default='output/adios_setting/', type=str, metavar='PATH',
...
def main(config):
    ...
    if dist.get_rank() == 0 and not os.path.exists(f'/scratch1/hag036/SimMIM_sketching/imgs/{config.TAG}'):
        os.makedirs(f'/scratch1/hag036/SimMIM_sketching/imgs/{config.TAG}')
