...
def eval_linear(args):
    ...
    model = models.vision_transformer.build_vit_base_lin_eval()
    model.cuda()
    model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--PRETRAINED', default='', type=str, metavar='MODEL',
    ...
    parser.add_argument("--base_lr", default=0.1, type=float, help="""Learning rate at the beginning of
    ...
    parser.add_argument('--data_path', default='/scratch1/hag036/imagenet100', type=str)
    parser.add_argument('--num_workers', default=10, type=int, help='Number of data loading workers per GPU.')
    parser.add_argument('--val_freq', default=1, type=int, help="Epoch frequency for validation.")
    parser.add_argument('--output_dir', default="output/lin_eval", help='Path to save logs and checkpoints')
    parser.add_argument('--num_labels', default=100, type=int, help='Number of labels for linear classifier')
    parser.add_argument('--dist_on_itp', action='store_true')
    parser.add_argument('--amp_forward', default=False, type=bool_flag, help='Use amp to inference the pre-trained model, which can speed up the evaluation. ')
